...
namespace game_msg
{
	...
	inline constexpr auto CODE_WRONG_SIZE		= "Wrong size of code !\0";
	inline constexpr auto CODE_OUT_OF_RANGE_L	= "Only digits from range [1, \0";
	inline constexpr auto CODE_OUT_OF_RANGE_R	= "] are allowed !";
	inline constexpr auto CODE_ONLY_DIGITS		= "Code should have only digits !\0";
	inline constexpr auto CODE_UNIQUE_DIGITS	= "Code should have unique digits !\0";
}